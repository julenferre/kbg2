...
char obj_kam_hautatu = 'o';                 //Transformazioak objektuan edo kameran eragin
char transf_helburua = 'g';				    //Transformazio lokala edo globala
...
void initialization (){
    ...
    //Tranformazio matrizeak kargatu
    init_matrizeak();
    /*Kamera hasiarazten da*/
    camera_init();
    /*Argia hasiarazten da*/
    argiak_init();
}
