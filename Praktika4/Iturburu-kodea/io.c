...
//Argiaren aldagaiak
extern char argia_tmota;
extern char argia_tardatza;
extern char argia_tnorabidea;

//Aldagai globala
extern char obj_kam_hautatu;
//Kamera mota (ortog, objektu-k, ibiltaria)
extern char kamera_mota;
//Argi mota (bonbila, eguzkia, fokua)
...
void print_help(){
    ...
    printf("<0>\t\t Argia mota aldatu(Bonbila,Eguzkia edo Fokoa)\n");
...
void keyboard(unsigned char key, int x, int y) {
    ...
    switch (key) {
        ...
        case 'C':
            ...
            kamera_mota_aldatu();
            break;
        case 48:  //0 Argia mota aldatu
            printf("Argia mota aldatu\n");
            argia_mota_aldatu();
            break;
        case 13: //Enter
            if(argiak_piztu == 1){
                ...
                printf("%s\n", "Argiak desgaitu dira" );
                argiak_piztu=0;
            }else{
                glEnable(GL_LIGHTING);
                printf("%s\n", "Argiak gaitutak daude" );
                argiak_piztu=1;
            }
            break;
        case 'k':
        ...
        case 'a':
        case 'A':
            printf("Aldaketak hautaturik dagoen argiari eragin\n");
            obj_kam_hautatu= 'a';
            break;
                    ...
                    switch (argia1->mota){
                        ...
                        switch (argia_tmota){
                            case 'm':
                                ...
                                break;
                            case 'b':
                                printf("%s\n", "Kontuz biraketarekin");
                                break;
                                }
                        case 'e':
                            switch (argia_tmota){
                                case 'm':
                                    printf("%s\n","Ezin da eguzkia bere lekutik mugitu" );
                                    break;
                                case 'b':
                                    argia_tardatza = 'X';
                                    argia_tnorabidea = '+';
